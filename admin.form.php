        ...
        <div class="col-xs-12">
           <div class="col-sm-6 col-md-offset-2 col-md-8">
             ...
             <div class="account-wall">
               ...
               <div class="col-md-7 pt-3">
                Sobrenome:
                <input type="text" class="form-control" placeholder="Sobrenome" required maxlength="70" autofocus name="snome">
				</div>
         ...
         <h5 class=" text-danger alert-danger">
          ...
          <div class="col-md-6 pt-3">
               ...
               <div class="col-md-6 pt-3">
                Repita a Senha:
                <input type="password" class="form-control" placeholder="Repita a Senha"  maxlength="60" required name="rsenha">
        </div>

               
             	 <div class="col-md-12 pt-3">
				Data de Nascimento:
                <input type="date" class="form-control" placeholder="" required autofocus maxlength="10" name="dtnasc">
				</div>
