...
<script type="text/javascript">
	...
	$('#formedit').submit(function(e) {
		...
		e.preventDefault();
		$.ajax({
        url: 'edit.professor.php', // caminho para o script que vai processar os dados
        type: 'POST',
        data: { dados:dados, },
        success: function(response) {
            $("#resultados").load("adm.professor.php #resultados"); //parte da mesma página
        },
	...
	$('#formdel').submit(function(e) {
		...
		e.preventDefault();
		$.ajax({
        url: 'del.professor.php', // caminho para o script que vai processar os dados
        type: 'POST',
        data: { dados:dados, },
        success: function(response) {
            $("#resultados").load("adm.professor.php #resultados"); //parte da mesma página
	...
	<div class="container">
		<div class="row"> 
			<div class="col-md-12">
				...
				<h2 class="text-center login-title">Adminstração - Professor</h2>
				<hr>				
						...
						<tbody style="background-color: #fff;">
							...
							if (isset($_SESSION['editresultid'])) {
								...
								while ($row=$stm->fetch(PDO::FETCH_ASSOC)) {
									...
									<!-- Colocar Form aqui -->
									<form class="form-cadastro" action="edit.professor.php" method="post"  id="formedit">
									<script type="text/javascript">
...
function checkall()
{
 ...
 else
 {
  return false;
									...
									<!-- Modal Deletar -->
									<div class="modal fade" id="ModalDel'.$row['id'].'" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
									<div class="modal-dialog" role="document">
									<div class="modal-content">
									<div class="modal-header">
									<h4>
									...
									<h4> Você tem certeza que deseja deletar o(a) professor(a) '.$row['nome'].'?  </h4>
									<h5> A ação não pode ser revertida... </h5>
									<hr>
								

									<!-- Colocar Form aqui -->
									<form class="form-cadastro" action="del.professor.php" method="post" id="formdel">
									...
									<div class="btn btn-dacor mt-2"  style="color: #fff;" data-toggle="modal" data-target="#ModalEdit'.$row['id'].'">  <img src="../images/edit.png" width="20px"/>  </div> 
									<!-- Fim Button trigger modal -->

									<a href="../professor.form.php" class="btn btn-dacor mt-2"  style="color: #fff;" ">   <img src="../images/add.png" width="20px"/> </div> 
									<!-- Fim Button trigger modal --></a>

									<div class="btn btn-danger mt-2"  style="color: #fff;" data-toggle="modal" data-target="#ModalDel'.$row['id'].'">  <img src="../images/del.png" width="20px"/>  </div> 
									<!-- Fim Button trigger modal -->
