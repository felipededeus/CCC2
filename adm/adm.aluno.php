  ...
  $('#formedit').submit(function(e) {
    ...
    $.ajax({
      ...
      success: function(response) {
        $("#resultados").load("adm.aluno.php #resultados");
...
<div class="jumbotron">
  <div class="container">
    <div class="row"> 
      <div class="col-md-12">
        <h2 class="text-center login-title">Adminstração - Aluno
        </h2>
        <hr>				
        ...
        <table id="resultados" class=" table table-bordered table-hover">
          <thead class="thead-light">
            <tr>
              ...
              <th>Telefone Reponsável
              </th>
              <th>Matricula Escolar
              </th>
              <th>E-mail Reponsável
              </th>
              <th>Cadastro Geral de Matrícula
              </th>
              <th>Ações
              </th>
            </tr>
