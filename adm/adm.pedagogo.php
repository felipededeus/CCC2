...
<script type="text/javascript">
	...
	$('#formedit').submit(function(e) {
		...
		e.preventDefault();
		$.ajax({
        url: 'edit.pedagogo.php', // caminho para o script que vai processar os dados
        type: 'POST',
        data: { dados:dados, },
        success: function(response) {
            $("#resultados").load("adm.pedagogo.php #resultados"); //parte da mesma página
        },
	...
	$('#formdel').submit(function(e) {
		...
		e.preventDefault();
		$.ajax({
        url: 'del.pedagogo.php', // caminho para o script que vai processar os dados
        type: 'POST',
        data: { dados:dados, },
        success: function(response) {
            $("#resultados").load("adm.pedagogo.php #resultados"); //parte da mesma página
	...
	<div class="container">
		<div class="row"> 
			<div class="col-md-12">
				...
				<h2 class="text-center login-title">Adminstração - Pedagogos</h2>
				<hr>				
						...
						<tbody style="background-color: #fff;">
							...
							if (isset($_SESSION['editresultid'])) {
								...
								while ($row=$stm->fetch(PDO::FETCH_ASSOC)) {
									...
									<a href="../pedagogo.form.php" class="btn btn-dacor mt-2"  style="color: #fff;" ">   <img src="../images/add.png" width="20px"/> </div> 
