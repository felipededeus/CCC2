...
<script type="text/javascript">
	...
	$('#formedit').submit(function(e) {
		...
		e.preventDefault();
		$.ajax({
        url: 'edit.curso.php', // caminho para o script que vai processar os dados
        type: 'POST',
        data: { dados:dados, },
	...
	<div class="container">
		<div class="row"> 
			<div class="col-md-12">
				...
				<h2 class="text-center login-title">Adminstração - Cursos</h2>
				<hr>				
						...
						<tbody style="background-color: #fff;">
							...
							if (isset($_SESSION['editresultid'])) {
								...
								while ($row=$stm->fetch(PDO::FETCH_ASSOC)) {
									...
									<!-- Colocar Form aqui -->
									<form class="form-cadastro" action="edit.curso.php" method="post"  id="formedit">
