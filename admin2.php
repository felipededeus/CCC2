...
<body>
  ...
  <div class="jumbotron m-5" >
    ...
    <h2 class="display-4 pb-5 ml-5">Painel Administrativo:</h2>
      ...
      <center>
        <!-- Button trigger modal -->
    <div class="btn btn-dacor"  style="color: #fff;" data-toggle="modal" data-target="#myModal"> <h4>   Cadastros    </h4>   </div>
        <!-- Fim Button trigger modal -->
        
         <!-- Button trigger modal -->
    <div class="btn btn-dacor"  style="color: #fff;" data-toggle="modal" data-target="#myModal"> <h4>  Relatórios    </h4>   </div>
        <!-- Fim Button trigger modal -->
